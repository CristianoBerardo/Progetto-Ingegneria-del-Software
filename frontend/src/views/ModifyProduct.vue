<template>
  <div class="modify-product">
    ...
    <div class="product-list" v-if="!selectedProductId && products.length > 0">
    ...
    <div v-else-if="!selectedProductId" class="no-products">
    ...
    async updateProduct() {
      ...
      try {
        const response = await axios.put(
          `http://localhost:3000/api/v1/products/${this.selectedProductId}`,
          updatedProduct,
          {
        ...
        if (response.data.success) {
          ...
          this.errorMessage = response.data.message || "Errore nell'aggiornamento del prodotto";
        }
      } catch (err) {
